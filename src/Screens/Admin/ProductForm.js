            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              <VStack space={6} mt={5}>
                ...
                <Select
                  ...
                  selectedValue={brand} // Set selected value to the brand state
                  onValueChange={(value) => setBrand(value)} // Update brand state when a brand is selected
                >
                  {brands.map((b, index) => {
                    return (
                      <Select.Item key={b.id} label={b.name} value={b.id} />
                    );
                  })}
                </Select>
